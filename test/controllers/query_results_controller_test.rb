...
class QueryResultsControllerTest < ActionController::TestCase
  ...
  test "should create query_result" do
    assert_difference('QueryResult.count') do
      post :create, query_result: { page_id: @query_result.page_id, position: @query_result.position, query_id: @query_result.query_id, result_id: @query_result.result_id }
    end
  ...
  test "should update query_result" do
    patch :update, id: @query_result, query_result: { page_id: @query_result.page_id, position: @query_result.position, query_id: @query_result.query_id, result_id: @query_result.result_id }
    assert_redirected_to query_result_path(assigns(:query_result))
  end
